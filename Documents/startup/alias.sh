...
[done]digital systems salehi
[done]subject --> syn cookie --> ganttchart
[done]1_eng resume to sigari
[done]haj mmdi serial communications
[done]import netfilterqueue --> made a firewall
[done]graph representation using bit map
[done]leet_code simple graph problem
[done]salehi resume --> moafiat --> firewall(make readme) --> tcp data hiding --> olympics
RESET 31 Oct
${NC}"
